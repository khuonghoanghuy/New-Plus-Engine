...
function onUpdatePost(elapsed)
    local BeforeScore = 'NPS: '..Nps..' (Max: '..MaxNps..') | Score: '..score..' | Phone Breaks: '..misses..' | Skills: '..ratingName
    local FinalScore = 'NPS: '..Nps..' (Max: '..MaxNps..') | Score: '..score..' | Phone Breaks: '..misses..' | Skills: '..ratingName..' ('..rateFullPer..'%) - '..ratingFC
